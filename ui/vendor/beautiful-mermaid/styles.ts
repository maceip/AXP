...
export const STROKE_WIDTHS = {
  /* AXP: strokes read as drawn lines rather than hairlines. */
  outerBox: 1.5,
  innerBox: 1.5,
  connector: 1.75,
} as const
...
export const ARROW_HEAD = {
  /* AXP: leaf-shaped heads need a little more room than the spec triangle. */
  width: 15,
  height: 9,
} as const

/** AXP: corner radius for rectangular nodes and polygon vertices. */
export const KAWAII = {
  rectRadius: 10,
  roundedRadius: 14,
  groupRadius: 16,
